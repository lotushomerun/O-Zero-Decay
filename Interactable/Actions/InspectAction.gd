...
func _execute(params: Array[Variant]) -> void:
	...
	Chatbox.header_message("[color=info]You take a closer look at %s...[/color]" % ("yourself" if interactable == Player.this.character.interactable else interactable.entity_name), Chatbox.ColorLib["info"])
